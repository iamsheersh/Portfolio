...
import { Mail, Briefcase, Code, User, Send, Linkedin, Github, Layout, MessageCircle, GitFork } from 'lucide-react';
...
const App = () => {
  ...
  return (
    <div className="bg-gray-900 text-gray-100 font-sans min-h-screen">
      ...
      {/* Navigation Bar with blur and sticky effect */}
      ...
      >
        ...
        >
          ...
          <motion.a
            ...
            className="mt-8 inline-block px-8 py-3 bg-sky-500 text-white text-lg font-semibold rounded-full shadow-lg hover:bg-sky-600 transition-all duration-300 transform hover:scale-110 cursor-pointer"
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <motion.section
          id="about"
          className="my-16 flex flex-col md:flex-row items-center gap-8 bg-gray-800 p-8 rounded-2xl shadow-xl transition-all duration-500 hover:shadow-2xl"
        ...
        >
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              I am Sheersh, a passionate 3rd-year BSc IT student. 
              I am driven by a deep curiosity for technology and a commitment to solving
               problems with code.
                My journey in the world of IT has equipped me with a solid foundation in programming
                 and an eagerness to learn new technologies.
                 I enjoy building things and am always looking for
        ...
        >
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex justify-center space-x-6">
              <a href="https://www.linkedin.com/in/sheersh-984437267/" className="p-3 rounded-full bg-sky-500 hover:bg-sky-600 transition-colors duration-300">
                <Linkedin size={24} />
              </a>
              <a href="https://github.com/iamsheersh" className="p-3 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors duration-300">
                <Github size={24} />
              </a>
